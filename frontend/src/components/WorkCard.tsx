...
export function WorkCard({ work, onClick, onLike, isLiked = false, index = 99 }: WorkCardProps) {
  ...
  useEffect(() => {
    ...
    // 自動ロードはindexに応じてずらし（一斉生成防止）、手動は即時
  ...
  // 画面に入ったら自動起動（index < MAX_CONTEXTS のカードのみ）
  useEffect(() => {
      ...
      >
        ...
        {work.is_official && (
          <div style={{
            ...
            boxShadow: '0 2px 8px rgba(0,0,0,0.15)', zIndex: 15,
          }}>
